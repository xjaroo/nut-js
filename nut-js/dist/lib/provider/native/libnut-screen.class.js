    ...
    grabScreen() {
        return new Promise((resolve, reject) => {
            ...
            if (screenShot) {
                ...
                resolve(new image_class_1.Image(screenShot.width, screenShot.height, screenShot.image.slice(0, screenShot.width * screenShot.height * 4), 4, "grabScreenResult", screenShot.bitsPerPixel, screenShot.byteWidth, colormode_enum_1.ColorMode.BGR, pixelScaling));
            }
            else {
    ...
    grabScreenRegion(region) {
        return new Promise((resolve, reject) => {
            ...
            if (screenShot) {
                ...
                resolve(new image_class_1.Image(screenShot.width, screenShot.height, screenShot.image.slice(0, screenShot.width * screenShot.height * 4), 4, "grabScreenRegionResult", screenShot.bitsPerPixel, screenShot.byteWidth, colormode_enum_1.ColorMode.BGR, pixelScaling));
            }
            else {
                reject("Unable to fetch screen content.");
            }
