...
KeyboardAction.KeyLookupMap = new Map([
    ...
    [key_enum_1.Key.RightAlt, "right_alt"],
    [key_enum_1.Key.RightControl, "right_control"],
    [key_enum_1.Key.LeftWin, "win"],
    [key_enum_1.Key.RightWin, "right_win"],
    [key_enum_1.Key.LeftCmd, "cmd"],
    [key_enum_1.Key.RightCmd, "right_cmd"],
    [key_enum_1.Key.Menu, "menu"],
    [key_enum_1.Key.Fn, "fn"],
