...
import { ColorQuery, LineQuery, WindowQuery, WordQuery } from "./query.class";
import { Window } from "./window.class";
export declare type WindowCallback = (target: Window) => void | Promise<void>;
export declare type MatchResultCallback<TARGET_TYPE> = (target: MatchResult<TARGET_TYPE>) => void | Promise<void>;
export declare type FindHookCallback = WindowCallback | MatchResultCallback<Point> | MatchResultCallback<Region>;
/**
...
export declare type PointResultFindInput = ColorQuery;
export declare type WindowResultFindInput = WindowQuery;
export declare type FindInput = RegionResultFindInput | WindowResultFindInput | PointResultFindInput;
export declare type FindResult = Region | Point | Window;
/**
