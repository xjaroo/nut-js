...
function isRegionResultFindInput(input) {
    return (0, image_class_1.isImage)(input) || (0, query_class_1.isTextQuery)(input);
}
function isPointResultFindInput(input) {
    return (0, query_class_1.isColorQuery)(input);
}
/**
...
class ScreenClass {
        ...
        try {
            if ((0, query_class_1.isWindowQuery)(needle)) {
                ...
                if (isRegionResultFindInput(needle)) {
                    ...
                    const resultPoint = new point_class_1.Point(searchRegion.left + matchResult.location.x, searchRegion.top + matchResult.location.y);
                    this.providerRegistry
                        .getLogProvider()
            ...
            if ((0, query_class_1.isWindowQuery)(needle)) {
                ...
                if (this.config.autoHighlight) {
                    ...
                    resultRegions.forEach((region) => {
                        if ((0, region_class_1.isRegion)(region)) {
                ...
                const matchRequest = (0, match_request_class_1.createMatchRequest)(this.providerRegistry, needle, searchRegion, 0, screenImage, params);
                validateSearchRegion(searchRegion, screenSize, this.providerRegistry);
                this.providerRegistry.getLogProvider().debug(`Search region is valid`);
                const matchResults = await (0, match_result_class_1.getMatchResults)(this.providerRegistry, matchRequest);
                const possibleHooks = this.getHooksForInput(needle) || [];
    ...
    getHooksForInput(input) {
        ...
        else if ((0, query_class_1.isColorQuery)(input)) {
            return this.findHooks.get(input);
        }
    ...
    validateSearchInput(functionName, needle) {
        if (!(0, image_class_1.isImage)(needle) &&
            !(0, query_class_1.isTextQuery)(needle) &&
            !(0, query_class_1.isWindowQuery)(needle) &&
            !(0, query_class_1.isColorQuery)(needle)) {
